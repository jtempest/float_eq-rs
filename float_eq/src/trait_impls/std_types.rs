...
macro_rules! impl_traits_for_wrapper {
    ($t:ident) => {
        impl<T: ?Sized + FloatUlps> FloatUlps for $t<T> {
            type Ulps = $t<Ulps<T>>;
        }
